...
def run():
    ...
    df.to_csv("FOUR_SPORTS/just_college_football_candidates.csv", index=False)
    singles.to_csv("FOUR_SPORTS/ready_singles_college_football.csv", index=False)
    #best_per_sport.to_csv("FOUR_SPORTS/best_per_sport.csv", index=False)
    best_overall.to_csv("FOUR_SPORTS/best_overall_college_football.csv", index=False)

    print("\nChecked sports (with results):")
    for s in checked_sports:
        print(" -", s)
    print("\nWrote: ALL_SPORTS/all_candidates.csv, ALL_SPORTS/ready_singles_all.csv, ALL_SPORTS/best_per_sport.csv, ALL_SPORTS/best_overall.csv")
    return df
